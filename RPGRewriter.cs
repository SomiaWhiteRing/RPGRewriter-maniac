...
namespace RPGRewriter
{
    class M
    {
            ...
            while (menuShow)
            {
                ...
                if (!commandLineMode)
                {
                    ...
                    Console.WriteLine("***** RPG Maker 200X Translation Assistant" + infoString + " *****\n"
                        + "Enter a number to toggle/cycle options for \"Go!\" function.\n"
                        + "1. " + globalMode + "\n"
                    ...
                    case "G1": // Check validity in StringScripts
                        ...
                        if (filepath != "")
                        {
                            ...
                            if (stringScriptImport(filepath))
                                Console.WriteLine("Strings imported from StringScripts.");
        ...
        public static void loadStringScript(string file, int commonEventNum = -1, bool troop = false, bool optional = false)
        {
            ...
            {
                if (!optional)
                    Console.WriteLine("StringScript not found for " + Path.GetFileNameWithoutExtension(file) + ".");
        ...
        {
            if (!stringScriptImportMode || importingStringArgs == null)
                return;
